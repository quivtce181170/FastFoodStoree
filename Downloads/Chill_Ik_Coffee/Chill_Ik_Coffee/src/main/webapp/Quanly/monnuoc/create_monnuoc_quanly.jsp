    ...
    <body>
        ...
        <form method="post">
            <div>
                ...
                <input type="text" id="name" name="name" required placeholder="Enter the name of the drink">
            </div>
            <div>
                <label for="gia">Price</label>
                <input type="number" id="gia" name="gia" required 
                       min="0" max="100000000" placeholder="Enter price">
            </div>
            <div>
                <label for="so_luong">Quantity</label>
                <input type="number" id="so_luong" name="so_luong" required 
                       min="0" max="100000000" placeholder="Enter quantity">
            </div>
            <div>
                <label for="loai_nuoc_id">Drink Type(ID)</label>
                <input type="number" id="loai_nuoc_id" name="loai_nuoc_id" required 
                       min="1" max="4" placeholder="Enter drink type(id)">
            </div>
            <div>
            ...
            <div>
                <label for="trang_thai">Status(Available)<input type="checkbox" id="trang_thai" name="trang_thai"></label>
            </div>

            <div>
                <button type="button" onclick="window.location.href = '<c:url value='/Menu' />'" id="back">Back</button>
