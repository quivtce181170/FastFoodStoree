 ...
 */
@WebServlet(name="deleteMenuServlet", urlPatterns={"/DeleteDrink"})
        ...
        if (session.getAttribute("user") == null) {
         ...
         String idParam = request.getParameter("id");
            ...
            if (idParam == null || idParam.isEmpty()) {
                ...
                request.getRequestDispatcher("Quanly/monnuoc/delete_monnuoc_quanly.jsp").forward(request, response);
                return;
            }
